    ...
    <>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={valor.titulo} className="bg-white border border-gray-100 rounded-2xl p-6 text-center shadow-sm hover:shadow-md transition">
                <div className="text-4xl mb-3">{valor.icono}</div>
                <h3 className="text-lg font-bold text-gray-700 mb-2">{valor.titulo}</h3>
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-700 mb-8">Nuestra Historia</h2>
