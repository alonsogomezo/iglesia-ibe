        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-ibe-celeste/10 rounded-2xl p-8">
              <h3 className="text-2xl font-bold text-ibe-celeste mb-4">
                Nuestra Misión
              </h3>
            ...
            <div className="bg-ibe-celeste/10 rounded-2xl p-8">
              ...
              <p className="text-ibe-gris leading-relaxed">
                Reproducir discípulos de Jesús y equiparlos para cumplir la gran
                comisión.
              </p>
            </div>
          </div>
      ...
      <section className="bg-gray-50 py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Link
              href="/devocional"
              className="bg-white border border-gray-100 hover:border-ibe-celeste rounded-2xl p-8 text-center shadow-sm hover:shadow-md transition"
            >
              ...
              <p className="text-ibe-gris text-sm">
                Reflexiones diarias para alimentar tu fe.
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-ibe-gris text-sm">
                Escucha nuestros mensajes y enseñanzas.
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-ibe-gris text-sm">
                Descubre cómo ser parte de nuestra comunidad.
              </p>
            </Link>
          </div>
        </div>
